...
public class BoxingGame {
    public static void main(String args[]) {
        ...
        System.out.println("Total number of punches used before game was over - " + p1.getTotalNoOfPunchesUsed()); //Print out the amount of Player's punches thrown  before ending
